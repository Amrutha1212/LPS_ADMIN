...
public class Loan implements Serializable {
	...
	@NotNull(message = "Please enter loan type")
	...
	@NotNull(message = "Please enter rate of interest")
	...
	@NotNull(message = "Please enter period")
	@Pattern(regexp = "([1-9]|1[0-9]).([0-9]{1,4})", message = "Please enter proper period (Eg. 2.5) and maximum of 20 years.")
	@Column(name = "period")
